...
function(t, e, i) {
	...
	o.Mixin.Events = {
		addEventListener: function(t, e, i) {
			...
			h = t[n],
			p ? (l = h + "_idx", u = l + "_len", c = d[l] = d[l] || {},
			c[p] || (c[p] = [], d[u] = (d[u] || 0) + 1), c[p].push(r)) : (d[h] = d[h] || [], d[h].push(r));
			return this
		},
	...
	o.DomUtil = {
		...
		testProp: function(t) {
			...
			n = 0; n < t.length; n++) if (t[n] in i) return t[n];
			return ! 1
		},
	...
	o.Map = o.Class.extend({
		...
		_onMouseClick: function(t) { ! this._loaded || !t._simulated && (this.dragging && this.dragging.moved() || this.boxZoom && this.boxZoom.moved()) || o.DomEvent._skipped(t) || (this.fire("preclick"), this._fireMouseEvent(t))
		},
	...
	o.Projection.Mercator = {
		...
		unproject: function(t) {
			for (var e, i = o.LatLng.RAD_TO_DEG,
			n = this.R_MAJOR,
			s = this.R_MINOR,
			a = t.x * i / n,
			r = s / n,
			h = Math.sqrt(1 - r * r), l = Math.exp( - t.y / n), u = Math.PI / 2 - 2 * Math.atan(l), c = 15, d = 1e-7, p = c, _ = .1; Math.abs(_) > d && --p > 0;) e = h * Math.sin(u),
	...
	o.Marker = o.Class.extend({
		...
		_onMouseClick: function(t) {
			var e = this.dragging && this.dragging.moved(); (this.hasEventListeners(t.type) || e) && o.DomEvent.stopPropagation(t),
	...
	o.Path = o.Path.extend({
		...
		_initEvents: function() {
			if (this.options.clickable) { (o.Browser.svg || !o.Browser.vml) && o.DomUtil.addClass(this._path, "leaflet-clickable"),
	...
	o.Path = o.Path.SVG && !t.L_PREFER_CANVAS || !o.Browser.canvas ? o.Path: o.Path.extend({
		...
		_drawPath: function() {
			...
			for (this._ctx.beginPath(), t = 0, i = this._parts.length; i > t; t++) {
				for (e = 0, n = this._parts[t].length; n > e; e++) s = this._parts[t][e],
				a = (0 === e ? "move": "line") + "To",
				this._ctx[a](s.x, s.y);
	...
	o.Polyline = o.Path.extend({
		...
		getPathString: function() {
			...
			i = ""; e > t; t++) i += this._getPathPartStr(this._parts[t]);
			return i
		},
		getLatLngs: function() {
		...
		closestLayerPoint: function(t) {
			...
			a = null,
			r = 0,
			h = s.length; h > r; r++) for (var l = s[r], u = 1, c = l.length; c > u; u++) {
				e = l[u - 1],
				i = l[u];
		...
		_clipPoints: function() {
			...
			h = o.LineUtil;
			for (t = 0, e = 0; s - 1 > t; t++) i = h.clipSegment(n[t], n[t + 1], r, t),
	...
	o.PolyUtil.clipPolygon = function(t, e) {
		...
		for (a = 0; 4 > a; a++) {
			...
			h = t[s],
			r._code & u ? h._code & u || (c = p._getEdgeIntersection(h, r, u, e), c._code = p._getBitCode(c, e), i.push(c)) : (h._code & u && (c = p._getEdgeIntersection(h, r, u, e), c._code = p._getBitCode(c, e), i.push(c)), i.push(r));
			t = i
		}
		return t
	},
	o.Polygon = o.Polyline.extend({
		...
		_initWithHoles: function(t) {
			var e, i, n;
			if (t && o.Util.isArray(t[0]) && "number" != typeof t[0][0]) for (this._latlngs = this._convertLatLngs(t[0]), this._holes = t.slice(1), e = 0, i = this._holes.length; i > e; e++) n = this._holes[e] = this._convertLatLngs(this._holes[e]),
	...
	o.Polygon.include(o.Path.CANVAS ? {
		_containsPoint: function(t) {
			...
			for (s = 0, h = this._parts.length; h > s; s++) for (e = this._parts[s], a = 0, l = e.length, r = l - 1; l > a; r = a++) i = e[a],
			n = e[r],
	...
	o.GeoJSON = o.FeatureGroup.extend({
		...
		addData: function(t) {
			...
			if (s) {
				for (e = 0, i = s.length; i > e; e++) n = s[e],
	...
	o.extend(o.GeoJSON, {
		geometryToLayer: function(t, e, i, n) {
			...
			case "MultiPoint":
				for (r = 0, h = u.length; h > r; r++) s = i(u[r]),
	...
	o.Map.Keyboard = o.Handler.extend({
		...
		addHooks: function() {
			var t = this._map._container; - 1 === t.tabIndex && (t.tabIndex = "0"),
	...
	o.Map.include({
		setView: function(t, e, n) {
			if (e = e === i ? this._zoom: this._limitZoom(e), t = this._limitCenter(o.latLng(t), e, this.options.maxBounds), n = n || {},
			this._panAnim && this._panAnim.stop(), this._loaded && !n.reset && n !== !0) {
				...
				if (s) return clearTimeout(this._sizeTimer),
				this
			}
	...
	o.Map.include(o.DomUtil.TRANSITION ? {
		...
		_tryAnimatedZoom: function(t, e, i) {
			...
			if (i = i || {},
			!this._zoomAnimated || i.animate === !1 || this._nothingToAnimate() || Math.abs(e - this._zoom) > this.options.zoomAnimationThreshold) return ! 1;
			var n = this.getZoomScale(e),
	...
	o.TileLayer.include({
		...
		_endZoomAnim: function() {
			...
			var i = this._map.getZoom(); (i > this.options.maxZoom || i < this.options.minZoom) && this._clearBgBuffer(),
			this._animating = !1
		},
		...
		_stopLoadingImages: function(t) {
			...
			for (e = 0, i = s.length; i > e; e++) n = s[e],
			n.complete || (n.onload = o.Util.falseFn, n.onerror = o.Util.falseFn, n.src = o.Util.emptyImageUrl, n.parentNode.removeChild(n))
		}
	}),
	o.Map.include({
